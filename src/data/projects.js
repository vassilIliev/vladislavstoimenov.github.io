...
The finale brings together the illusions and disappointments of the characters, leaving the audience alone with the feeling that nothing happens by chance — even when we believe we are simply making bread.`,
  ...
  'red-speedo': {
    ...
    author: 'Lucas Hnath',
    type: 'directing',
    venue: 'Drama and Puppet Theatre "Vasil Drumev", Shumen',
    year: '2026',
    status: 'completed',
    ...
    fullDescription: `"Red Speedo" by American playwright Lucas Hnath explores one of the most pressing questions of contemporary society: the pursuit of success at any cost. How far is a person willing to go in order to be first? To what extent do the desire for victory and the need for recognition shape our choices and determine our actions?

What drives this relentless need to prove oneself? In a society increasingly defined by competition, performance, and visibility, people often come to measure their worth through their achievements. Success becomes not only a goal but also a condition for recognition, belonging, and self-definition. But if one fails to reach the top, does that mean they lose their value, their identity, or even their sense of purpose?

Today, individuals are increasingly expected to perform, produce, and constantly surpass themselves. Human worth is often assessed through measurable results, social prestige, and public validation. As a consequence, personal identity becomes inseparable from achievement, while failure is experienced not merely as a setback but as an existential threat.

These questions are at the core of my interest in staging "Red Speedo". The play exposes the moral compromises, personal sacrifices, and psychological pressures generated by a culture obsessed with winning. Ultimately, it asks whether a person is willing to risk everything in the pursuit of success—and whether they can live with the consequences of that choice.`,
    cast: [
    ...
    images: [
      ...
      { src: '/images/red-speedo/red-speedo-09.jpeg', alt: 'Production photo', caption: 'On stage in Shumen' },
